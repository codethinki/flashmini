 ...
 */
        Tensor solarizeAdd(const Tensor& input, const float threshold, const float addValue);
 ...
 */
        Tensor oneHot(const Tensor& targets, const int numClasses, const float labelSmoothing);
