 ...
 */
    ...
    public:
        ...
        public:
            ...
            explicit param_type(RealType a = 1.0, RealType b = 1.0) : a_param(a),
                                                                      b_param(b) {}
        ...
        explicit beta_distribution(RealType a = 1.0, RealType b = 1.0) : a_gamma(a),
                                                                         b_gamma(b) {}
        explicit beta_distribution(const param_type& param) : a_gamma(param.a()),
                                                              b_gamma(param.b()) {}
