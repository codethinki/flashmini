...
RandomNumberGenerator::RandomNumberGenerator(int seed /* = 0 */) : randomEngine_(seed),
                                                                   uniformDist_(0, 1),
                                                                   gaussianDist_(0, 1) {}
...
std::vector<float> genTestSinWave(size_t numSamples, size_t freq, size_t sampleRate, float amplitude) {
