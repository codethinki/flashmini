...
namespace pkg {
    namespace speech {
        ...
        public:
            ...
            std::vector<int> beamPath(const Tensor& input, const Tensor& inputSizes, int beamSize = 10);
            ...
            std::pair<std::vector<std::vector<float>>, std::vector<Seq2SeqStatePtr>> decodeBatchStep(
                ...
                const float smoothingTemperature = 1.0
            ) const;
